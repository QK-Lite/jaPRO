...
XCVAR_DEF( g_mercenaryExplosivesAmmo,	"15",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_mercenaryStartForcePoints, "75",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_mercenaryAllowWeaponPull,	"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_mercenaryFlameDamage,		"15",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_allowRefuseTele,			"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_allowKnockMeDown,			"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_amKnockMeDownJump,			"375",			NULL,				CVAR_ARCHIVE,									qtrue )
